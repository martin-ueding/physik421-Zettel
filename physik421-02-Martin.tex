...
\begin{align*}
	S_2 + S_3
	&= \int_{-\infty}^\infty \dif x \, \bigg(
	- \frac{\ii \alpha}{\hbar} \del{\hat p^\dagger - \bracket{\hat p}} \phi^\dagger(x, t) \del{x - \bracket x} \phi(x, t) \\
	...
	\ii \hbar \dpd{}x \phi^\dagger(x, t) x \phi(x, t) + \ii \hbar \dpd{}x \phi^\dagger(x, t) \bracket x \phi(x, t) + \bracket{\hat p} \phi^\dagger(x, t) x \phi(x, t) \\
	...
	&= \frac{\ii \alpha}{\hbar} \bracket x \bracket{\hat p}
\end{align*}
