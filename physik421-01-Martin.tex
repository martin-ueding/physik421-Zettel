...
\begin{align*}
	...
	&= \frac1{\sqrt{2\piup}} \int_{\infty}^\infty \dif x \int_{\infty}^\infty \dif k \, \exp\del{\ii k(x-\omega)} \phi(x) \\
	\intertext{%
		Das innere Integral über $k$ kann nur konvergieren, wenn $x-\omega=0$
		gilt. In diesem Falle ist der Wert $\infty$. Für alle anderen Werte von
		$x-\omega$ ist das Integral 0. Dies ist $\delta(x-\omega)$.
	}
	&= \frac1{\sqrt{2\piup}} \int_{\infty}^\infty \dif x \, \delta(x-\omega) \phi(x) \\
